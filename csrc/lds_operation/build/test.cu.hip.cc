...
int main(int argc, char ** argv) {
    ...
    hipMalloc(&offset_0_device, sizeof(float) * BLOCK_SIZE);
    hipMalloc(&offset_1_device, sizeof(float) * BLOCK_SIZE);
    ...
    hipMemcpy(offset_0_host, offset_0_device, sizeof(index_t) * BLOCK_SIZE, hipMemcpyDeviceToHost);
    hipMemcpy(offset_1_host, offset_1_device, sizeof(index_t) * BLOCK_SIZE, hipMemcpyDeviceToHost);

    hipFree(offset_0_device);
    free(offset_0_host);
    hipFree(offset_1_device);
    free(offset_1_host);
}
